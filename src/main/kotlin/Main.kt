...
//}
    fun division( passwords:Int){
        var passwords = "emmilys67steph"
    if (passwords in passwords <= 8) {
        println("valid")
    }
    else if (passwords in passwords <= 16){
        println("valid")
    }
    else {
   println("not valid")
...
class CurrentAccount(var accNo:Int,var accName: String,balance:Double){
